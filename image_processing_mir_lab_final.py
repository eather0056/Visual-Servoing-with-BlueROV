...
# Data Publisher
Current_point = rospy.Publisher('/vis/Current_point', Float64, queue_size=10)
Desiar_point = rospy.Publisher('/vis/Desiar_point', Float64, queue_size=10)
...
def subscribers():
    # default image topic
	image_topic_name = "/br4/usb_cam/image_raw/compressed"
