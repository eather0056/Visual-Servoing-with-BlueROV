...
# global variables for the depth control
global desired_depth
global Kp
desired_depth = 0.5  # desired depth in meters
...
def PressureCallback(data):
	...
	# ...
	# Calculate the current depth with respect to the surface
	current_depth = depth_wrt_startup
