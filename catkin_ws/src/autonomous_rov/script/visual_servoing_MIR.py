...
def desiredpointscallback(data):
    ...
    rospy.logdebug("Desired point updated: {}".format(desired_point_vs))

def trackercallback(data):
    global current_point_vs, desired_point_vs
    current_point_vs = data.data
    rospy.logdebug("Current point updated: {}".format(current_point_vs))
...
def subscriber():
    ...
    # Subscribing to visual servoing topics
